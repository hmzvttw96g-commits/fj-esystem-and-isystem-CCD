...
para("结果与解读：①双核“全链协调”、无明显断裂——但相对薄弱链节恰与障碍度呼应：福州最弱在产业内部（D₃₄=0.874）、"
     ...
     "标准化值为 0（经核宁德师范学院 2019—2021 三批省级一流名单确无 AI/计算机类专业入选，系真零而非缺失），凡含质量的链节即“断裂”"
     "（此为 CCD 零值地板，须注明系“质量链节缺失”而非负向错配；莆田原同此，但其系数据缺口——经补入莆田学院 2020 年计算机"
     "省级一流后已非零，D₁₂=0.293、D₂₄=0.204）。"
